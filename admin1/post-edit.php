                ...
                <div class="card-body">
                    ...
                    if (isset($_GET['id'])) {
                        ...
                        if (mysqli_num_rows($post_query_res) > 0) {
                            ...
                            <form action="code.php?id=<?= $post_row['id'] ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" name="meta_title" value=" <?= $post_row['meta_title'] ?>" max="191"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="checkbox" name="status" <?= $post_row['status'] == '1' ? 'checked' : '' ?>
                                            width="70px" height="70px" />
                                    </div>


                                    <div class="col-md-6 mb-3">
                                        <button type="submit" name="post_update" class="btn btn-primary"
                                            value="<?= $post_row['id'] ?>">Update Post</button>
                                    </div>
